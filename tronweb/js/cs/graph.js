...
(function() {
  ...
  GraphModalView = (function(_super) {
    __extends(GraphModalView, _super);
    ...
    function GraphModalView() {
      ...
      this.attachEvents = __bind(this.attachEvents, this);
      this.initialize = __bind(this.initialize, this);
      _ref1 = GraphModalView.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
