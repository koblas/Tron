...
(function() {
  ...
  module.NavView = (function(_super) {
    ...
    NavView.prototype.sorter = function(items) {
      var containsQuery, item, lengthSort, query, startsWithQuery, uncasedItem, _i, _len, _ref1;
      _ref1 = [[], []], startsWithQuery = _ref1[0], containsQuery = _ref1[1];
    ...
    NavView.prototype.setActive = function() {
      var params, path, _ref1;
      this.$('li').removeClass('active');
      _ref1 = modules.routes.getLocationParams(), path = _ref1[0], params = _ref1[1];
      path = path.split('/')[0];
