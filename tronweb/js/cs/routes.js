...
(function() {
  var MainView, module, _ref, _ref1,
  ...
  module.TronRoutes = (function(_super) {
    __extends(TronRoutes, _super);

    function TronRoutes() {
      _ref = TronRoutes.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  module.updateLocationParam = function(name, value) {
    var base, params, _ref2;
    _ref2 = module.getLocationParams(), base = _ref2[0], params = _ref2[1];
    params[name] = value;
