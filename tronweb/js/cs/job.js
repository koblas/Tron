...
(function() {
  var JobListEntryView, JobRunListEntryView, JobRunListSliderModel, JobRunTimelineEntry, formatInterval, module, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
  ...
  window.JobCollection = (function(_super) {
    ...
    function JobCollection() {
      ...
      this.initialize = __bind(this.initialize, this);
      _ref1 = JobCollection.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  window.JobRun = (function(_super) {
    ...
    function JobRun() {
      ...
      this.initialize = __bind(this.initialize, this);
      _ref2 = JobRun.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  window.JobListFilterModel = (function(_super) {
    __extends(JobListFilterModel, _super);

    function JobListFilterModel() {
      _ref3 = JobListFilterModel.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
  ...
  window.JobListView = (function(_super) {
    ...
    function JobListView() {
      ...
      this.initialize = __bind(this.initialize, this);
      _ref4 = JobListView.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
    ...
    JobListView.prototype.initialize = function(options) {
      ...
      this.listenTo(this.refreshView, 'refreshView', function() {
  ...
  JobListEntryView = (function(_super) {
    __extends(JobListEntryView, _super);

    function JobListEntryView() {
      this.initialize = __bind(this.initialize, this);
      _ref5 = JobListEntryView.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  window.JobView = (function(_super) {
    ...
    function JobView() {
      ...
      this.initialize = __bind(this.initialize, this);
      _ref6 = JobView.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
    ...
    JobView.prototype.formatSettings = function(attrs) {
      var content, icon, template, title, _ref7;
      template = _.template("<span class=\"label-icon tt-enable\" title=\"<%= title %>\">\n    <i class=\"icon-<%= icon %>\"></i>\n</span>");
      _ref7 = attrs.allow_overlap ? ['layers', "Allow overlapping runs"] : attrs.queueing ? ['circlepauseempty', "Queue overlapping runs"] : ['remove-circle', "Cancel overlapping runs"], icon = _ref7[0], title = _ref7[1];
  ...
  module.JobRunListView = (function(_super) {
    __extends(JobRunListView, _super);

    function JobRunListView() {
      this.render = __bind(this.render, this);
      this.renderList = __bind(this.renderList, this);
      this.initialize = __bind(this.initialize, this);
      _ref7 = JobRunListView.__super__.constructor.apply(this, arguments);
      return _ref7;
    }
  ...
  JobRunListEntryView = (function(_super) {
    __extends(JobRunListEntryView, _super);

    function JobRunListEntryView() {
      this.initialize = __bind(this.initialize, this);
      _ref8 = JobRunListEntryView.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
  ...
  window.JobRunView = (function(_super) {
    __extends(JobRunView, _super);
    ...
    function JobRunView() {
      ...
      this.renderList = __bind(this.renderList, this);
      this.initialize = __bind(this.initialize, this);
      _ref9 = JobRunView.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
    ...
    JobRunView.prototype.initialize = function(options) {
      ...
      return this.listenTo(this.refreshView, 'refreshView', function() {
        return _this.model.fetch();
      });
    };
