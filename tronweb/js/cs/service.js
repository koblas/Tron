...
(function() {
  var ServiceInstanceView, ServiceListEntryView, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  window.Service = (function(_super) {
  ...
  window.ServiceInstance = (function(_super) {
    __extends(ServiceInstance, _super);

    function ServiceInstance() {
      _ref1 = ServiceInstance.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  window.ServiceCollection = (function(_super) {
    ...
    function ServiceCollection() {
      ...
      this.initialize = __bind(this.initialize, this);
      _ref2 = ServiceCollection.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  window.ServiceListView = (function(_super) {
    __extends(ServiceListView, _super);

    function ServiceListView() {
      this.renderList = __bind(this.renderList, this);
      this.initialize = __bind(this.initialize, this);
      _ref3 = ServiceListView.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
  ...
  ServiceListEntryView = (function(_super) {
    __extends(ServiceListEntryView, _super);

    function ServiceListEntryView() {
      this.initialize = __bind(this.initialize, this);
      _ref4 = ServiceListEntryView.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  window.ServiceView = (function(_super) {
  ...
  ServiceInstanceView = (function(_super) {
    __extends(ServiceInstanceView, _super);

    function ServiceInstanceView() {
      _ref6 = ServiceInstanceView.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
