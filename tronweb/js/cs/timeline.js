...
(function() {
  ...
  module.TimelineView = (function(_super) {
    ...
    function TimelineView() {
      ...
      _ref = TimelineView.__super__.constructor.apply(this, arguments);
      return _ref;
    }
    ...
    TimelineView.prototype.render = function() {
      var data, svg, x, xAxis, y, yAxis, _ref1, _ref2;
      this.$el.html('');
      data = this.model;
      _ref1 = [this.buildX(data), this.buildY(data)], x = _ref1[0], y = _ref1[1];
