...
(function() {
  var ActionRunHistorySliderModel, module, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6,
  ...
  module.ActionRun = (function(_super) {
    __extends(ActionRun, _super);

    function ActionRun() {
      this.parse = __bind(this.parse, this);
      this.url = __bind(this.url, this);
      this.initialize = __bind(this.initialize, this);
      _ref = ActionRun.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  module.ActionRunHistoryEntry = (function(_super) {
    __extends(ActionRunHistoryEntry, _super);

    function ActionRunHistoryEntry() {
      this.parse = __bind(this.parse, this);
      _ref1 = ActionRunHistoryEntry.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
  ...
  module.ActionRunHistory = (function(_super) {
    __extends(ActionRunHistory, _super);
    ...
    function ActionRunHistory() {
      ...
      this.url = __bind(this.url, this);
      this.initialize = __bind(this.initialize, this);
      _ref2 = ActionRunHistory.__super__.constructor.apply(this, arguments);
      return _ref2;
    }
  ...
  module.ActionRunHistoryListEntryView = (function(_super) {
    __extends(ActionRunHistoryListEntryView, _super);

    function ActionRunHistoryListEntryView() {
      _ref3 = ActionRunHistoryListEntryView.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
  ...
  module.ActionRunListEntryView = (function(_super) {
    __extends(ActionRunListEntryView, _super);

    function ActionRunListEntryView() {
      this.initialize = __bind(this.initialize, this);
      _ref4 = ActionRunListEntryView.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  module.ActionRunView = (function(_super) {
    __extends(ActionRunView, _super);

    function ActionRunView() {
      this.initialize = __bind(this.initialize, this);
      _ref5 = ActionRunView.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  module.ActionRunHistoryView = (function(_super) {
    __extends(ActionRunHistoryView, _super);

    function ActionRunHistoryView() {
      this.render = __bind(this.render, this);
      this.renderList = __bind(this.renderList, this);
      this.initialize = __bind(this.initialize, this);
      _ref6 = ActionRunHistoryView.__super__.constructor.apply(this, arguments);
      return _ref6;
    }
